# 
#   R functions for creating lag and environmental variable matrices, modified from Teller et al (2016) Methods in Ecology and Evolution 7:171-183.
#   
#   Written in 2017 by Andrew Tyre atyre2@unl.edu
#
...
makeDat = function(envData, response, monthStart, nUnits, meas){
